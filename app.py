...
st.write("Ingresa los datos en vivo para calcular probabilidades y detectar valor.")
...
with col1:
    ...
    xg_l = st.number_input("Goles Esperados (xG) Local", min_value=0.00, value=0.85, step=0.05, key="lxG")
...
with col2:
    ...
    xg_v = st.number_input("Goles Esperados (xG) Visitante", min_value=0.00, value=0.20, step=0.05, key="vxG")
...
if st.button("📊 Calcular Predicción Avanzada", use_container_width=True, type="primary"):
    ...
    # 3. PROYECCIÓN DE GOLES AJUSTADA POR xG
    ...
    # Factor de Eficiencia: Evalúa si el equipo merece más goles de los anotados
